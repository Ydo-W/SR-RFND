...
if __name__ == '__main__':
    ...
    train_dataset = dataset.BandGapDataset(para, 'train', mask=None, isNormalize=False)
    ...
    val_dataset = dataset.BandGapDataset(para, 'val', mask=None, isNormalize=False)
    ...
    test_data = np.loadtxt(data_file_path)
